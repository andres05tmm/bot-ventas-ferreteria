...
Plans:
- [ ] 01-01-PLAN.md — Create db.py module with ThreadedConnectionPool, schema init, and wire into boot sequence
...
|-------|----------------|--------|-----------|
| 1. DB Infra + Catálogo + Inventario | 0/3 | Planning complete | - |
