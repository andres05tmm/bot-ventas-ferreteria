...
- **Global scope**: `C:/Users/Dell/Documents/GitHub/bot-ventas-ferreteria/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `C:/Users/Dell/Documents/GitHub/bot-ventas-ferreteria/.claude/notes/`)
...
2. Glob `C:/Users/Dell/Documents/GitHub/bot-ventas-ferreteria/.claude/notes/*.md` (if directory exists) — global notes
...
Global (C:/Users/Dell/Documents/GitHub/bot-ventas-ferreteria/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `C:/Users/Dell/Documents/GitHub/bot-ventas-ferreteria/.claude/notes/` — works in any directory
